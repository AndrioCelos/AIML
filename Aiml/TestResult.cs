...
namespace Aiml {
	...
	public class TestResult {
		...
		public static TestResult Pass(TimeSpan duration) => new TestResult(true, null, duration);
		public static TestResult Failure(string message, TimeSpan duration) => new TestResult(false, message, duration);
