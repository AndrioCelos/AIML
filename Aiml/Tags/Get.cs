...
public partial class TemplateNode {
	...
	public sealed class Get(TemplateElementCollection key, TemplateElementCollection tuple, bool local) : TemplateNode {
		...
		public static Get FromXml(XmlNode node, AimlLoader loader) {
			...
			return key != null ? new Get(key, tupleKey, localVar) : throw new AimlException("get tag is missing a name or var property.");
		}
	}
}
