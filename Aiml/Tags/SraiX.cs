...
public partial class TemplateNode {
	...
	/// </remarks>
	/// <seealso cref="Srai"/>
	public sealed class SraiX(TemplateElementCollection serviceName, XmlAttributeCollection attributes, TemplateElementCollection defaultReply, TemplateElementCollection children) : RecursiveTemplateTag(children) {
		public TemplateElementCollection ServiceName { get; } = serviceName;
		public XmlAttributeCollection Attributes { get; } = attributes;
		public TemplateElementCollection DefaultReply { get; } = defaultReply;
